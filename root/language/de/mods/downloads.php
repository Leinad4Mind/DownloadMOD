...
$lang = array_merge($lang, array(
	...
	'CLICK_RETURN_CATEGORYADMIN'			=> '%sKlick hier, um zur Kategorie Administration zurückzukehren%s',
	'CLICK_RETURN_COMMENTS'					=> '%sKlick hier, um zu den Kommentaren zurückzukehren%s',
	'CLICK_RETURN_DL_CONFIG'				=> '%sKlick hier, um zur Download Konfiguration zurückzukehren%s',
	...
	'CLICK_RETURN_DOWNLOADS'				=> '%sKlick hier, um zu den Downloads Kategorien zurückzukehren%s',
	'CLICK_RETURN_EXTBLACKLISTADMIN'		=> '%sKlick hier, um zur Blackliste für Dateiendungen zurückzukehren%s',
	'CLICK_RETURN_FILE_MANAGEMENT'			=> '%sKlick hier, um zur Dateiverwaltung zurückzukehren%s',
	...
	'CLICK_RETURN_USER_TRAFFIC_ADMIN'		=> '%sKlick hier, um den Traffic eines weiteren Benutzers zu verändern%s',
	'CLICK_RETURN_USERGROUP_TRAFFIC_ADMIN'	=> '%sKlick hier, um den Traffic einer weiteren Benutzergruppe zu verändern%s',

	'DL_CONFIRM_DELETE_BUG_REPORT'	=> 'Bist Du sicher, diese Fehlermeldung zu löschen?',
	...
	'DL_ACP_BROWSER'					=> 'User Agents verwalten',
	'DL_ACP_FILES_MANAGEMENT'			=> 'Downloads verwalten',
	'DL_ACP_MANAGEMANT_PAGE'			=> 'Download MOD Administration',
	'DL_ACP_MANAGEMANT_PAGE_EXPLAIN'	=> 'Auf dieser Seite erreichst Du alle Einstellungen und Funktionen der Download MOD, die zur Verwaltung gehören.<br />Wähle eine der links angeführten Funktionen, um die betreffenden Einstellungen vornehmen zu können.',
	...
	'DL_ACTIVE'							=> 'Download MOD aktivieren',
	'DL_ADD'							=> 'Addieren',
	...
	'DL_CONFIRM_CAT_COMMENTS_DELETE'	=> 'Bist Du sicher, die Kommentare der Kategorie <strong>%s</strong> zu löschen?',
	'DL_CONFIRM_CAT_DELETE'				=> 'Willst Du die Kategorie <strong>%s</strong> wirklich löschen?',
	'DL_CONFIRM_CAT_STATS_DELETE'		=> 'Bist Du sicher, die Statistikdaten der Kategorie <strong>%s</strong> zu löschen?',
	'DL_CONFIRM_DELETE_BAN_VALUES'		=> 'Bist Du sicher, diese Bannlisteneinträge zu löschen?',
	'DL_CONFIRM_DELETE_EXTENTION'		=> 'Bist Du sicher, die Dateiendung <strong>%s</strong> zu entfernen?',
	'DL_CONFIRM_DELETE_EXTENTIONS'		=> 'Bist Du sicher, die Dateiendungen <strong>%s</strong> zu entfernen?',
	...
	'DL_CONFIRM_DELETE_USER_AGENTS'		=> 'Bist du sicher, diesen Eintrag und alle damit gespeicherten User Agents zu löschen?',
	'DL_CONFIRM_DELETE_VERSIONS'		=> 'Bist du sicher, die gewählten Versionen zu löschen?',
	...
	'DL_FIELD_DELETE_CONFIRM'		=> 'Bist du sicher, das Downloadfeld zu entfernen?',
	...
	'DL_FILE_NAME'					=> 'Datei',
	'DL_FILE_NEW'					=> '* Neu *',
	'DL_FILE_NOT_FOUND'				=> '<strong>Datei %s nicht gefunden!</strong><br /><br />Stelle sicher, daß diese Datei im Ordner %s existiert!',
	'DL_FILE_SIZE'					=> 'Größe',
	...
	'DL_HACK_AUTOR'			=> 'Autor',
	'DL_HACK_AUTOR_EMAIL'	=> 'Autor Email',
	...
	'DL_LOG_ALL_TR_ADD'		=> '<strong>Download Traffic hinzugefügt</strong><br />» Traffic für alle Benutzer: %1$s %2$s',
	'DL_LOG_ALL_TR_SET'		=> '<strong>Download Traffic gesetzt</strong><br />» Traffic für alle Benutzer: %1$s %2$s',
	'DL_LOG_AUTO_TR_GRP'	=> '<strong>Automatischer Download Traffic eingerichtet</strong><br />» Benutzergruppe: %1$s<br /> » Traffic: %2$s %3$s',
	'DL_LOG_AUTO_TR_USER'	=> '<strong>Automatischer Download Traffic eingerichtet</strong><br />» Benutzer ohne Gruppe/Gäste: %1$s %2$s',
	'DL_LOG_BAN_ADD'		=> '<strong>Download Bannliste ergänzt</strong><br />» User: %1$s, IP: %2$s, Browser: %3$s, Gäste: %4$s',
	'DL_LOG_BAN_DEL'		=> '<strong>Einträge von der Download Bannliste entfernt</strong><br />» %s',
	'DL_LOG_BAN_EDIT'		=> '<strong>Download Bannliste bearbeitet</strong><br />» User: %1$s, IP: %2$s, Browser: %3$s, Gäste: %4$s',
	'DL_LOG_BROWSER_SAVE'	=> '<strong>Benutzerbrowser gespeichert</strong>',
	'DL_LOG_BROWSER_DEL'	=> '<strong>Benutzerbrowser gelöscht</strong>',
	'DL_LOG_CAT_ADD'		=> '<strong>Download Kategorie erstellt</strong><br />» %s',
	'DL_LOG_CAT_DEL'		=> '<strong>Download Kategorie gelöscht</strong><br />» %s',
	'DL_LOG_CAT_EDIT'		=> '<strong>Download Kategorie bearbeitet</strong><br />» %s',
	'DL_LOG_CAT_MOVE'		=> '<strong>Download Kategorie verschoben</strong><br />» %s',
	'DL_LOG_CAT_PERM_ALL'	=> '<strong>Berechtigungen für Kategorie geändert</strong><br />» %1$s<br />» Ansicht: %2$s<br />» Download: %3$s<br />» Upload: %4$s<br />» Moderation: %5$s<br />» Kommentare ansehen: %6$s<br />» Kommentare erstellen: %7$s',
	'DL_LOG_CAT_PERM_COPY'	=> '<strong>Berechtigungen von Download Kategorie kopiert</strong><br />» von "%1$s" nach "%2$s"',
	'DL_LOG_CAT_PERM_GRP'	=> '<strong>Berechtigungen für Kategorie geändert</strong><br />» %1$s für Benutzergruppe %2$s<br />» Ansicht: %3$s<br />» Download: %4$s<br />» Upload: %5$s<br />» Moderation: %6$s',
	...
	'DL_LOG_DEL_CAT_COM'	=> '<strong>Kommentare der Download Kategorie gelöscht</strong><br />» %s',
	'DL_LOG_DEL_CAT_STATS'	=> '<strong>Statistik der Download Kategorie gelöscht</strong><br />» %s',
	'DL_LOG_DEL_FILE'		=> '<strong>Download gelöscht</strong><br />» %s',
	'DL_LOG_EXT_ADD'		=> '<strong>Download Dateierweiterung verboten</strong><br />» %s',
	'DL_LOG_EXT_DEL'		=> '<strong>Download Dateierweiterung(en) zugelassen</strong><br /> » %s',
	'DL_LOG_FIELD_ACTIVATE'	=> '<strong>Downloadfeld aktiviert</strong><br /> » %s',
	'DL_LOG_FIELD_CREATE'	=> '<strong>Downloadfeld erstellt</strong><br /> » %s',
	'DL_LOG_FIELD_DEACT'	=> '<strong>Downloadfeld deaktiviert</strong><br /> » %s',
	'DL_LOG_FIELD_EDIT'		=> '<strong>Downloadfeld geändert</strong><br /> » %s',
	'DL_LOG_FIELD_REMOVED'	=> '<strong>Downloadfeld entfernt</strong><br /> » %s',
	'DL_LOG_FILE_ADD'		=> '<strong>Download hinzugefügt</strong><br />» %s',
	'DL_LOG_FILE_ASS'		=> '<strong>Datei zu Download zugeordnet</strong><br />» %s',
	'DL_LOG_FILE_DROP'		=> '<strong>Nicht zugeordnete Download Datei gelöscht</strong><br />» %s',
	'DL_LOG_FILE_EDIT'		=> '<strong>Download bearbeitet</strong><br />» %s',
	'DL_LOG_FILE_MOVE'		=> '<strong>Download verschoben</strong><br />» %s',
	'DL_LOG_FILES_CHECK'	=> '<strong>Downloads überprüft und syncronisiert</strong>',
	'DL_LOG_FILES_SORT'		=> '<strong>Alle Downloads der Kategorie sortiert</strong><br />» %s',
	'DL_LOG_FOLDER_CREATE'	=> '<strong>Download Ordner erstellt</strong><br />» %s',
	'DL_LOG_FOLDER_DROP'	=> '<strong>Download Ordner gelöscht</strong><br />» %s',
	'DL_LOG_GRP_TR_ADD'		=> '<strong>Download Traffic hinzugefügt</strong><br />» Benutzergruppe: %1$s<br /> » Traffic: %2$s %3$s',
	'DL_LOG_GRP_TR_SET'		=> '<strong>Download Traffic gesetzt</strong><br />» Benutzergruppe: %1$s<br /> » Traffic: %2$s %3$s',
	...
	'DL_LOG_USER_TR_ADD'	=> '<strong>Download Traffic hinzugefügt</strong><br />» Benutzer: %1$s<br /> » Traffic: %2$s %3$s',
	'DL_LOG_USER_TR_SET'	=> '<strong>Download Traffic gesetzt</strong><br />» Benutzer: %1$s<br /> » Traffic: %2$s %3$s',
	...
	'DL_OFF_HIDE'				=> 'Link in Board-Navigation verstecken (wenn MOD inaktiv)',
	...
	'DL_PERM_ALL'				=> 'Jeder',
	'DL_PERM_ALL_DROP_CONFIRM'	=> 'Bist du sicher, die Berechtigungen aller Kategorien zurückzusetzen?<br /><br />Dieser Vorgang kann nicht rückgängig gemacht werden, so dass du die Berechtigungen erneut setzen musst!',
	'DL_PERM_CATS_DROP_CONFIRM'	=> 'Bist du sicher, die Berechtigungen der nachfolgenden Kategorien zurückzusetzen?<br />%s<br />Dieser Vorgang kann nicht rückgängig gemacht werden, so dass du die Berechtigungen erneut setzen musst!',
	...
	'DL_TRAFFICS_FOUNDER_INFO'		=> 'Information für Forengründer',
	...
	'DL_TRANSLATION'				=> 'Download MOD Deutsch &copy; by OXPUS',

	'DL_UA_FILE_NOT_WRITABLE'	=> 'Die Datei mit den User Agents ist nicht beschreibbar!<br />Bitte prüfen die Dateirechte nach, damit deine Änderungen gespeichert werden können.',
	'DL_UNAPPROVED'				=> '[ nicht freigegeben ]',
	'DL_UNASSIGNED_FILES'		=> 'Prüfe nicht zugeordnete Downloads',
	'DL_UCONF_LINK'				=> 'Link zur Benutzerkonfiguration anzeigen',
	...
	'DL_USER_AGENT_EXPLAIN'		=> '(für die Bannliste)',
	'DL_USER_AGENTS'			=> 'User Agents',
	'DL_USER_AGENTS_EXPLAIN'	=> '(Suchbegriffe)',
	'DL_USER_AGENTS_DELETED'	=> 'Browser mit allen zugeordneten User Agents erfolgreich gelöscht',
	'DL_USER_AGENTS_EDIT'		=> 'Hier kannst du die User Agents des gewählten Browser (s. u.) einsehen, nach denen die Bannliste bestimmte Zugriffsprogramme/Scripte sperren kann.',
	'DL_USER_AGENTS_LIST'		=> 'Hier kannst du die Liste der Browser einsehen, nach denen du in der Bannliste (dort als Inhalt für "Webbrowser") bestimmte Zugriffsprogramme/Scripte sperren kannst.<br />Hinter diesen Browsern stehen allerdings die tatsächlichen User Agents, also die Teile der vom Programm (z. B. Webbrowser) übertragenen Kennung, nach der die Bannliste prüft.<br />Sofern du folglich einen neuen Browser einträgst, musst du auch die User Agents, die damit verbunden sind, ebenfalls noch nachtragen, um diese Einträge in der Bannliste auch tatsächlich verwenden zu können.',
	'DL_USER_AGENTS_NOT_SAVED'	=> 'Deine Änderungen konnten nicht gespeichert werden!<br />Bitte prüfen die Dateirechte auf deinem Server nach und wiederhole deine Änderungen.',
	'DL_USER_AGENTS_SAVED'		=> 'Deine Änderungen wurden erfolgreich gespeichert',
	'DL_USER_AUTO_TRAFFIC'		=> 'Traffic für Benutzer',
	'DL_USER_AUTO_TRAFFIC_USER'	=> 'Traffic für den Benutzer erfolgreich aktualisiert',
	'DL_USER_BANNED'			=> 'Du bist im Download Bereich gebannt worden und kannst daher keine Dateien herunterladen.<br />Bitte wende dich an einen Administrator, wenn du mit dem Bann nicht einverstanden bist.', 
	...
	'DOWNLOAD_PATH'		=> 'Pfad zu Deinen Downloads, z.B. ’dl_mod/downloads/’',
	...
	'IMG_BUTTON_DL_UPLOAD'	=> 'Datei hochladen',
	'IMG_CAT_DLMOD'			=> 'Download MOD',
	'IMG_DL_BANLIST'		=> 'Bannliste',
	'IMG_DL_BLUE'			=> 'Blau',
	'IMG_DL_BUTTON'			=> 'Download',
	'IMG_DL_DEFAULT'		=> 'Enthält keine neuen oder aktualisierten Downloads',
	'IMG_DL_EDIT'			=> 'Enthält geänderte Downloads',
	'IMG_DL_FILE_EDIT'		=> 'aktualisierter Download',
	'IMG_DL_FILE_NEW'		=> 'neuer Download',
	'IMG_DL_GREEN'			=> 'Grün',
	'IMG_DL_GREY'			=> 'Grau',
	'IMG_DL_NEW'			=> 'Enthält neue Downloads',
	'IMG_DL_NEW_EDIT'		=> 'Enthält neue und geänderte Downloads',
	'IMG_DL_RATE_NO'		=> 'Kein Bewertungspunkt',
	'IMG_DL_RATE_YES'		=> 'Bewertungspunkt',
	'IMG_DL_RED'			=> 'Rot',
	'IMG_DL_WHITE'			=> 'Weiß',
	'IMG_DL_YELLOW'			=> 'Gelb',

	'IMG_BUTTON_DOWNLOAD_UPLOAD'		=> 'Eine Datei hochladen',
	'IMG_BUTTON_DOWNLOAD_SEARCH'		=> 'Download suchen',

	'MUST_SELECT_DOWNLOAD'	=> 'Wähle einen Download aus',

	'NEW_DOWNLOAD'					=> 'Es ist ein Download neu hochgeladen oder aktualisiert worden.<br />Klick %shier%s, um zu den Downloads zu gehen.',
	...
	'USER_ALLOW_FAV_DOWNLOAD_EMAIL'		=> 'Email bei Änderungen an abonnierten Downloads senden',
	'USER_ALLOW_FAV_COMMENT_EMAIL'		=> 'Email bei neuen Kommentaren zu abonnierten Downloads senden',
	'USER_ALLOW_FAV_DOWNLOAD_POPUP'		=> 'Board Nachricht bei Änderungen an abonnierten Downloads anzeigen',
	'USER_ALLOW_NEW_DOWNLOAD_EMAIL'		=> 'Email bei neuen Downloads senden',
	'USER_ALLOW_NEW_DOWNLOAD_POPUP'		=> 'Board Nachricht bei neuen Downloads anzeigen',
	'USER_DOWNLOAD_EMAIL'				=> 'Email<br />Nachricht',
