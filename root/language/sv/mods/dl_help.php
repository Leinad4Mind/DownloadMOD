...
* @file				dl_help.php 20 2013/06/11 OXPUS
...
$lang = array_merge($lang, array(
	'HELP_TITLE' => 'Downloads online-hjälp',
	...
	'HELP_DL_APPROVE'			=> 'Med denna funktion godkänns filen direkt.<br />Aktiveras funktionen ej så döljs filen för alla medlemmar tills en administratör godkänner den.',
	...
	'HELP_DL_CHOOSE_CATEGORY'	=> 'Välj den kategori där filen passar in bäst.',
	...
	'HELP_DL_DISABLE_EMAIL'			=> 'Med hjälp av denna funktion kan du aktivera eller helt deaktivera epost-meddelanden om nya eller ändrade filer.<br />Om funktionen har aktiverats globalt så kan den fortfarande deaktiveras individuellt när en ny fil laddas upp eller en bestående fil ändras.<br />Endast medlemmar som har aktiverat funktionen epost-meddelanden i den egna kontrollpanelen kommer att meddelas.<br />Kontrollpanelen kan öppnas via länken i filområdets sidfot.',
	...
	'HELP_DL_DISABLE_POPUP'			=> 'Med hjälp av denna funktion kan du aktivera eller helt deaktivera popup-meddelanden eller forummeddelanden om nya eller ändrade filer.<br />Om funktionen har aktiverats globalt så kan den fortfarande deaktiveras individuellt när en ny fil laddas upp eller en bestående fil ändras.<br />Endast medlemmar som har aktiverat funktionen popup-meddelanden eller forummeddelanden i den egna kontrollpanelen kommer att meddelas.<br />Kontrollpanelen kan öppnas via länken i filområdets sidfot.',
	...
	'HELP_DL_EXTERN'				=> 'Aktivera denna funktion om du vill länka in en extern fil (http://www.example.com/media.pdf).<br />Funktionen "Fri" används ej.',
	'HELP_DL_EXTERN_UP'				=> 'Aktivera denna funktion om du vill länka in en extern fil (http://www.example.com/media.pdf). Funktionen "Fri" används ej.',

	'HELP_DL_FILE_DESCRIPTION'	=> 'En kort beskrivning av filens innehåll.<br />Denna information visas även i kategorin.<br />BBCoder är ej tillåtna.<br />Mata endast in korta texter så att laddningstiden för kategorin reduceras.',
	'HELP_DL_FILE_HASH_ALGO'	=> 'Defines, which method will be used to calculate the hash value for each download.<br />The hash will be calculated for all downloads and all of the existing variants, but they will only be shown in the download details when the settings are enabled there.<br />You can use the methods md5 and sha1, because these methods are mostly installed by default on the servers.<br />The mod will calculate the hash automatically on add or edit a download. Also the hash will be calculated on open the detail view, if the hash was not calculated and saved before. This was build for an updated mod or when you have changed the hash method.<br /><br />Hint:<br />When the hash method was changed, all existing hash values will be dropped, because they are not build within the selected hash method!',
	...
	'HELP_DL_HACK_VERSION'			=> 'Filens release/version.<br />Denna information visas intill filen i downloads.<br />Denna information kan ej hittas med sökfunktionen.',
	...
	'HELP_DL_IS_FREE'			=> 'Aktivera denna funktion om filen ska kunna laddas ner av vem som helst.<br />Trafikkontot kommer ej att användas.<br />Välj "Fri för reg. medlemmar" om du endast vill att registrerade medlemmar ska kunna ladda ner filen.',
	...
	'HELP_DL_NAME'					=> 'Detta är rubriken för filen, rubriken visas på flera olika ställen i filområdet downloads.',
	...
	'HELP_DL_TRAFFIC'					=> 'Den maximala trafiken som denna fil får orsaka.<br />Värdet 0 deaktiverar funktionen.',
	...
	'HELP_DL_TRAFFICS_USERS'			=> 'This option will set a limit to the user traffics for registered users.<br />The user traffic can be enabled or disabled for all registered users or can be set only for members of the user groups which can be selected in the next option.<br />If the user traffic was disabled all affected users can unlimit download and upload files.<br />Die affrected users also will not get automatic traffic amounts and will not get traffic points while writing a topic or post even this options are enabled, too.',
	...
	'HELP_DL_UPLOAD_FILE'			=> 'Ladda upp en fil från din dator.<br />Se till att filens storlek ej överstiger det angivna värdet och att filens typ ej finns med i listan över förbjudna filtyper.',
